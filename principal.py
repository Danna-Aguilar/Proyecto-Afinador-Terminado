...
class App(tk.Tk):
    def __init__(self):
        ...
        etiqueta_frecuencias = tk.Label(text = "Frecuencia fundamental: ", font=("Calibri", 10,"bold"),bg=("light blue"))
        etiqueta_frecuencias.grid(column=0, row=19)

        self.etiqueta_valor_ff = tk.Label(text = "-", font=("Calibri", 10,"bold"),bg=("light blue"))
        self.etiqueta_valor_ff.grid(column=1, row=19)

        etiqueta_cuerda = tk.Label(text = "Cuerda: ", font=("Calibri", 10,"bold"),bg=("light blue"))
        etiqueta_cuerda.grid(column = 0, row = 10)

        self.cuerda_valor = tk.Label(text = "-", font=("Calibri", 10,"bold"),bg=("light blue"))
        self.cuerda_valor.grid(column=1, row=10)

        etiqueta_ajuste = tk.Label(text = " Estado: ", font=("Calibri", 10,"bold"),bg=("light blue"))
        etiqueta_ajuste.grid(column = 0, row = 12)

        self.estado_valor = tk.Label(text = "-", font=("Calibri", 10,"bold"),bg=("light blue"))
